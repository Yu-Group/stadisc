...
class CausalTreeRegressor(object):
    ...
    """
    def __init__(self, ate_alpha=.05, control_name=0, max_depth=None, feature_split=0.25,
    ...
    def fit(self, X, treatment, y):
        ...
        """
        self.max_features = round(self.feature_split*X.shape[1])
        
        if self.max_features < 1:
            raise ValueError('Number of max features less than 1. Increase feature_split parameter')
        ...
        splitter = RandomSplitter(criterion = CausalMSE(1, X.shape[0]),
